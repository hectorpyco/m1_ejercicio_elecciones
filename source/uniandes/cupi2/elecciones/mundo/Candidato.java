...
public class Candidato
{
    ...
    public Candidato( String nNombre, String nApellido, 
    					String nPartidoPolitico, int nEdad )
    {
        nombre = nNombre;
        apellido = nApellido;
        ...
        votosInfluenciaInternet = 0; votosMasculinos = 0;votosFemeninos = 0;
        votosEdadJoven =0;votosEdadMayor =0; votosEdadMedia=0;
    ...
    {
        votos = 0;votosEdadJoven=0;votosEdadMayor=0;votosEdadMedia=0;votosFemeninos=0;
        votosMasculinos=0;
