...
public class Urna
{
    ...
    public Urna( )
    {
        ...
        candidato2 = new Candidato( "Marco", "Benitez", "ANR", 34 );

        // Inicializa el candidato 3
        candidato3 = new Candidato( "Mario", "Abdo", "UNACE", 37 );
    }
    ...
    {
        return candidato1.darVotosInfluenciaInternet() + 
        		candidato2.darVotosInfluenciaInternet() + 
        		candidato3.darVotosInfluenciaInternet();
    }
    ...
    {
    	return candidato1.darVotosGeneroFemenino()+
    			candidato2.darVotosGeneroFemenino()+
    ...
    {
    	return candidato1.darVotosGeneroMasculino()+ 
    			candidato2.darVotosGeneroMasculino()+ 
    ...
    {
    	return candidato1.darVotosEdadJoven()+
    			candidato2.darVotosEdadJoven()+
    			candidato3.darVotosEdadJoven();
    }
    ...
    {
    	return candidato1.darVotosEdadMedia()+
    			candidato2.darVotosEdadMedia()+
    			candidato3.darVotosEdadMedia();
    }
    ...
    {
    	return candidato1.darVotosEdadMayor()+
    			candidato2.darVotosEdadMayor()+
    			candidato3.darVotosEdadMayor();
    }
